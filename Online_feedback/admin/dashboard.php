...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color:#1D1D1D">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">College Feedback Management System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation" style="background-color:#1A1A1A">
