...
<h1 class="page-header" align="center">Update Faculty<p>
...
<div class="col-lg-8" style="margin-bottom:100px;">
  ...
  <input type="text"  name="sem" value="<?php echo @$res['semester'];?>" class="form-control" required>
	...
	<div class="control-group form-group">
    	<div class="controls">
            	<input type="submit" class="btn btn-success" style="background-color:#FF8000; border:hidden" name="save" value="Update  Faculty">
        </div>
  	</div>
	</form>
