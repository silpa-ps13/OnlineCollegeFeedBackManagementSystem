...
<html lang="en">
 ...
 <link href="../images/images/slider-pages/28167740_148170662535075_5174622239009728066_n.jpg" rel="icon" type="img/png">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"  style="margin-bottom: 0; background-color:#202020">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar"  >
          <ul class="nav nav-sidebar"style="background-color:#202020">
		...
		@$page=  $_GET['page'];
		  ...
		  <h1 class="page-header" align="center">Dashboard
           <p><img src="../images/images/slider-pages/slider-pages/Untitled-1.png"></h1>
