...
<form method="post">
	...
	<div class="row" style="margin-top:10px">
		...
		<input type="submit" value="Update Password"  style="background-color:#FF8000; border:hidden;"name="save" class="btn btn-success"/>
		<input type="reset"   style="background-color:#FF8000; border:hidden;" class="btn btn-success"/>
		</div>
	</div>
</form>	