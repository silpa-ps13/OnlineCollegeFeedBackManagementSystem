...
<form method="post" style="margin-top:100px;">
	<div class="row">
		...
		<div class="col-sm-4"><h2 align="center">Faculty Login Form</h2></div>
	</div>
	...
	<div class="row" style="margin-top:10px">
		<div class="col-sm-4"></div>
		<div class="col-sm-8">
		<input type="submit" value="Login" style="background-color:#FF8000; border:hidden;" name="save" class="btn btn-info"/>
