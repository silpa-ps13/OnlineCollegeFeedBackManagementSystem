<?php
	...
	if(isset($login))
	{
$que=mysqli_query($conn,"select email and password from hod where email='$email' and password='$pass'");
...
<body background="../images/images/slider-pages/slider-pages/slider-1.jpg">
                    ...
                    <div class="panel-body">
                        <form method="post">
                            <fieldset>
								...
								<div class="form-group">
                                    <input name="login" type="submit" style="background-color:#FF8000; border:hidden;" value="Login" class="btn btn-lg btn-success btn-block">
                                </div>
