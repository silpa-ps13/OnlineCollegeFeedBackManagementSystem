...
if(isset($update_password))
{
	...
	$que=mysqli_query($conn,"select password from hod");
	...
	{
		mysqli_query($conn,"update hod set password='$cp'");
...
<tr>
	<th rowspan="2"><input type="submit" value="Update Password" name="update_password"  style="background-color:#FF8000; border:hidden;"class="btn btn-success"/></th>
</tr>
</table>
</form>
