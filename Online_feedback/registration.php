...
$query="insert into user values('','$n','$e','$pass','$mob','$pro','$dep','$sem','$gen','$hob','$dob',now())";
...
?>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					<td> Your Course</td>
					<Td><input name="pro" class="form-control" required>
				...
				<tr>
					...
					<Td><input name="dep" class="form-control" required>
