...
?>
<h2 align="center" style="margin-bottom:50px; margin-top:50px">Update Password  <p><img src="../images/images/slider-pages/slider-pages/Untitled-1.png"></h2>
<form method="post">
	...
	<div class="row" style="margin-top:10px">
		...
		<input type="submit" value="Update Password"  style="background-color:#FF8000"name="save" class="btn btn-success"/>
		<input type="reset" style="background-color:#FF8000" class="btn btn-success"/>
		</div>
	</div>
</form>	