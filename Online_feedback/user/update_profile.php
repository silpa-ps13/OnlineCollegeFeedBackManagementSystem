...
?>
<h2 align="center" style="margin-top:50px">Update Your Profile
  <p><img src="../images/images/slider-pages/slider-pages/Untitled-1.png"></h2><br></h2>
...
<input type="submit" class="btn btn-default"  style="background-color:#FF8000; color:#CCC" value="Update My Profile" name="update"/>
<input type="reset" class="btn btn-default" style="background-color:#FF8000;color:#CCC" value="Reset"/>
